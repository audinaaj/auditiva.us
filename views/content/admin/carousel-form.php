...
<?php
    ...
    // TAB: Content
    //--------------------
    $tabContent = '<div class="col-md-8"><br />';

    $tabContent .= $form->field($model, 'intro_text')->label('Text')->widget(letyii\tinymce\Tinymce::className(), [
        'options' => [
            'id' => 'idIntroText',
        ],
    ...
    // Options
    //--------------------
    $tabOptions = '<div class="col-md-2"><br />';
    ...
    //        //['prompt'=>'--Select One--']    // options
    //    );
    $tabOptions .= Html::activeHiddenInput($model, 'show_image', ['value' => true]);
    ...
    //);
    $tabOptions .= Html::activeHiddenInput($model, 'content_type_id', ['value' => 7]);  // 7 = carousel
    ...
    $tabImages .= '        <h4 class="modal-title" id="winModalMediaGalleryLabel">Medial Gallery</h4>';
    $tabImages .= '    </div>';
