...
<div class="content-view">
    ...
    <p>
        <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i> '  . Yii::t('app', 'Update'), ['motd-update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
        ...
        <?= Html::a('<i class="fa fa-plus" aria-hidden="true"></i> '  . Yii::t('app', 'Add'), ['motd-create', 'id' => $model->id], ['class' => 'btn btn-success']) ?>
        <?= Html::a('<i class="fa fa-clone" aria-hidden="true"></i> ' . Yii::t('app', 'Clone'), ['motd-clone', 'id' => $model->id], ['class' => 'btn btn-default']) ?>
    </p>
