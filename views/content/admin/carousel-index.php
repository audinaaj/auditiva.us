...
$this->title = Yii::t('app', 'Carousel List');
...
<div class="content-index">
    ...
    <p>
        <?= Html::a('<i class="fa fa-plus" aria-hidden="true"></i> ' . Yii::t('app', 'Create Carousel'), ['carousel-create'], ['class' => 'btn btn-success']) ?>
                ...
                'buttons' => [
                    'view'     => function ($url, $model, $key) {
                        return Html::a('<i class="glyphicon glyphicon-eye-open d-icon"></i>', 
                          Url::toRoute(['carousel-view', 'id' => $model['id']]));  // link to view record
                    },
                    'update'   => function ($url, $model, $key) {
                        return Html::a('<i class="glyphicon glyphicon-pencil d-icon"></i>', 
                          Url::toRoute(['carousel-update', 'id' => $model['id']]));  // link to update record
                    },
