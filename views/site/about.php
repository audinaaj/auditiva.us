...
<div class="site-about">
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-8">
                <h1>Who We Are</h1>
                <img src="<?= Yii::$app->homeUrl; ?>img/aboutus/about-people-bw.png" class="img-responsive" align="left" width="750">
                <p>&nbsp;</p>
                ...
                <img src="<?= Yii::$app->homeUrl; ?>img/aboutus/madeinusa.jpg" align="right">
            ...
            <div class="col-lg-4">
                <h1>Our Mission</h1>
                <img src="<?= Yii::$app->homeUrl; ?>img/aboutus/productionlab-bw.jpg" class="img-responsive" align="left" width="360">
                <p>&nbsp;</p>
